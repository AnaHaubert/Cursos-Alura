function setupHackEditor(params = {}) {
    ...
    function uploadImage(image, onSuccess, onError) {
    ...
    const defaultEditorOptions = {
        ...
        spellChecker: false,
        previewRender: (content) => params.extensions.marked(content),
    ...
    const updateOutputField = (editor) => {
        ...
        outputField.value = editor.core.options.previewRender(editor.core.value());
    }
